...
class MailTest(TestCase):
    ...
    @override_settings(EMAIL_BACKEND='post_nord.tests.test_mail.ConnectionTestingBackend')
    ...
    def test_get_batch_size(self):
        ...
        setattr(settings, 'POST_NORD', {'BATCH_SIZE': 10})
        self.assertEqual(get_batch_size(), 10)
        settings.POST_NORD = previous_settings
    ...
    def test_get_threads_per_process(self):
        ...
        setattr(settings, 'POST_NORD', {'THREADS_PER_PROCESS': 10})
    ...
    def test_get_log_level(self):
        ...
        setattr(settings, 'POST_NORD', {'LOG_LEVEL': 1})
        self.assertEqual(get_log_level(), 1)
        # Restore ``LOG_LEVEL``
        setattr(settings, 'POST_NORD', {'LOG_LEVEL': 2})
        settings.POST_NORD = previous_settings
