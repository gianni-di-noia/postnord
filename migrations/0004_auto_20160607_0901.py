...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='emails',
            field=models.ManyToManyField(related_name='attachments', to='post_nord.Email', verbose_name='Email addresses'),
        ),
        migrations.AlterField(
            model_name='attachment',
            name='file',
            field=models.FileField(upload_to=post_nord.models.get_upload_path, verbose_name='File'),
        ),
        migrations.AlterField(
            model_name='attachment',
            name='name',
        ...
        migrations.AlterField(
            model_name='email',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='post_nord.EmailTemplate', verbose_name='Email template'),
        ),
        migrations.AlterField(
            model_name='emailtemplate',
            name='default_template',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translated_templates', to='post_nord.EmailTemplate', verbose_name='Default template'),
        ),
        migrations.AlterField(
            model_name='emailtemplate',
            name='description',
        ...
        migrations.AlterField(
            model_name='log',
            name='email',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='logs', to='post_nord.Email', verbose_name='Email address'),
        ),
        migrations.AlterField(
            model_name='log',
            name='exception_type',
