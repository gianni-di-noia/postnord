...
from post_nord.fields import CommaSeparatedEmailField
...
def get_upload_path(instance, filename):
    ...
    return "post_nord_attachments/" + filename
...
class Attachment(models.Model):
    ...
    emails = models.ManyToManyField(
        Email, related_name="attachments", verbose_name=_("Email addresses")
    )
